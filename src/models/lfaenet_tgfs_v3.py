...
if __name__ == '__main__':
    ...
    attn = toks.ne(0).long()
    model = LFAENetTGFSv3(in_channels=1, num_classes=1, text_dim=256, vocab_size=2000, text_encoder_type='simple', use_external_text_encoder=False, drop_hh_in_decoder=True).to(device)
