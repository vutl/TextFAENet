...
def apply_experiment_preset(args) -> None:
    if args.experiment == "cxr_bert_v6":
        ...
        # Train on train+val combined for exactly 49 epochs (v6 best epoch).
        # No early stopping. Uses test split for monitoring only.
        # Expected +2-4pp test_dice from using 25% more labeled data.
        args.model_type = "lfaenet_tgfs_v2"
        args.prompt_source = "csv"
        args.use_cxr_bert = True
        args.freeze_text_backbone = True
        ...
        args.max_pos_weight = 16.0
        args.weight_decay = 5e-4
        args.early_stop_patience = 0  # disabled — no independent val set
        args.balanced_sampling = True
        args.use_tta = True
        args.epochs = 49
        args.encoder_type = "resnet50"
...
def main() -> None:
    ...
    parser.add_argument("--experiment", type=str, choices=["cxr_bert_v6", "cxr_bert_v7a"], default="cxr_bert_v6")
